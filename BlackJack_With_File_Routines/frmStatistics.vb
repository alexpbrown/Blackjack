...
Public Class frmStatistics
    ...
    Private Sub frmStatistics_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If frmBlackJack_Main.Statistics(frmBlackJack_Main.PLAYER).intWon >= 1 Then
        ...
        lstGeneralDealer.Items.Add("Total Hands...................." & vbTab & frmBlackJack_Main.Statistics(frmBlackJack_Main.DEALER).intTotalHands.ToString)
        ...
        lstGeneralPlayer.Items.Add("Total Hands...................." & vbTab & frmBlackJack_Main.Statistics(frmBlackJack_Main.PLAYER).intTotalHands.ToString)
